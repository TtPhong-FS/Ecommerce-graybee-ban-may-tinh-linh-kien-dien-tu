...
function Promotions() {
  const promotions = [
    ...
    },
    {
      ...
      description: '',
      imageUrl:
        'https://file.hstatic.net/200000722513/file/thang_04_van_phong_banner_web_slider_800x400.jpg'
    }
  ]
  ...
  return (
    <div className='bg-white p-6 rounded-lg shadow-md'>
      <div className='flex justify-between items-center mb-6'>
        <h1 className='text-gray-800'>Chuyên trang khuyến mãi</h1>
        <Link
          to={'#'}
        ...
        {promotions.map((promo, index) => (
          ...
          >
            <img
              src={promo.imageUrl}
              alt={promo.title}
              className='w-full h-36 object-cover md:h-32 lg:h-40'
            />
            <div className='p-4'>
              ...
              {promo.subtext && (
                <p className='text-xs text-gray-500'>{promo.subtext}</p>
              )}
            </div>
          </div>
        ))}
